...
class Exp_Main(Exp_Basic):
    ...
    def test(self, setting, test=0, return_pdf_results=False, no_save=False):
        ...
        print('mse:{}, mae:{}, consistency:{}, consistency_mse:{}, inverse_consistency:{}, inverse_consistency_mse:{}'.format(mse, mae, consistency, consistency_mse, inverse_consistency, inverse_consistency_mse))
        f = open("result.txt", 'a')
        f.write(setting + "  \n")
        ...
        f.write('\n')
        f.close()
        tqdm.write('mse:{}, mae:{}, consistency:{}, consistency_mse:{}, inverse_consistency:{}, inverse_consistency_mse:{}'.format(mse, mae, consistency, consistency_mse, inverse_consistency, inverse_consistency_mse))

        if not no_save:
            print(f"Save result: {folder_path}")
