...
class Exp_AliO(Exp_Main):
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in tqdm(enumerate(vali_loader), desc='Validation', total=len(vali_loader), leave=False):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in tqdm(enumerate(train_loader), desc=f'Epoch {epoch}: training', total=len(train_loader), leave=False):
                ...
                assert self.args.alio_num_samples == num_samples
