...
d_model_list=(32 32 32 32)
d_ff_list=(32 32 32 32)
...
for random_seed in 2023 2024 2025; do
    for i in "${!pred_len_list[@]}"; do
        ...
        # pred_len이 192, 720일 때만 --train_epochs 1 추가
        if [ "$pred_len" -eq 192 ] || [ "$pred_len" -eq 720 ]; then
...
echo "Finished training weather dataset"
